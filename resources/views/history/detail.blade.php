        ...
        <div class="col-md-12">
            <div class="card mt-2">
                <div class="card-header">
                    ...
                    <h3>Sukses Check Out <button style="float: right; margin:5px 5px 0px 0px;" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Upload
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset($pesanan->meja->sektor->photo) }}" width="120px" alt="">
                                    </td>
