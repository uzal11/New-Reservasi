                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="card" style="width: 100%;">
                                        <img class="card-img-top" src="{{ $pesanan->meja->sektor->photo }}" alt="Card image cap" style="float: left; width:120px; margin-right:5px; ">
                                        <div class="card-body" style="float: left">
                                            ...
                                            <p class="card-text">
                                                ...
                                                <br>
                                            <form action="{{ url('update_status') }}/{{ $pesanan->id }}" method="post">
                                                @csrf
                                ...
                                <td>
                                    ...
                                    {{ $pesananmenu->jumlah }} {{ $pesananmenu->menu->nama }} - {{ $pesananmenu->total_harga}} 
                                    </span>
                                    @endforeach
                                </td>
