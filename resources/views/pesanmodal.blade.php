        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button style="float: right; margin:5px 5px 0px 0px;" class="btn btn-primary" data-toggle="modal" data-target="#menu-model-{{$menu->id}}">Tambah</button>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="{{ url('order/'.$menu->id) }}">
                                                @csrf
                                                <input type="number" min="1" name="jumlah_pesanan" class="form-control" required>
                                                <input type="hidden" name="menu_id" value="{{$menu->id}}" class="form-control" required>
